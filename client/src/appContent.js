  ...
  return (
    <>
      ...
      {userInfo && userInfo.isDelivery ? (
        <DeliveryLayout>
          <Routes>
            <Route path="/deliveryhomepage" element={<DeliveryHomepage />} />
            <Route
        ...
        <AdminLayout>
          <Routes>
            ...
            ></Route>
            <Route path="/admin/coupon" element={<CreateOfferpage />}></Route>
            <Route path="/deliverydetails" element={<DeliveryDetails />} />
            <Route
              path="/:orderId/orderscreenstatus"
              element={<OrderStatusScreen />}
            />
            <Route path="/admin/incomebycity" element={<IncomeByCity />} />
            <Route
              path="/admin/product/create"
              element={<CreateProductPage />}
              exact
            />
            <Route path="/admin/bulkupload" element={<BulkUploadPage />} />
            {/* <Route
            ...
            <Route path="/adminvideobanner" element={<AdminVideoBanner />} />
            <Route
